...
const liturgicalCalendar = (date = currentDate, country = 'france') => {
  ...
  */
  ...
  if (firstAdventSunday.hasSame(date, 'day')) data.name = "Premier dimanche de l'Avent, <em>Levavi</em>", data.color[0] = ["purple"], data.grade = 1, data.rank = 2
  if (secondAdventSunday.hasSame(date, 'day')) data.name = "Deuxième dimanche de l'Avent, <em>Populus Sion</em>", data.color[0] = ["purple"], data.grade = 1, data.rank = 2
  if (thirdAdventSunday.hasSame(date, 'day')) data.name = "Troisième dimanche de l'Avent, <em>Gaudete</em>", data.color[0] = ["pink"], data.grade = 1, data.rank = 2
  if (fourthAdventSunday.hasSame(date, 'day')) data.name = "Quatrième dimanche de l'Avent, <em>Rorate</em>", data.color[0] = ["purple"], data.grade = 1, data.rank = 2
  if (immaculateConception.hasSame(date, 'day')) data.name = "Immaculée Conception de la Bienheureuse Vierge Marie", data.color[0] = ["white"], data.grade = 1, data.rank = 3
  if (holyFamily.hasSame(date, 'day')) data.name = "La Sainte Famille", data.color[0] = ["white"], data.grade = 2, data.rank = 5
  if (epiphany.hasSame(date, 'day')) data.name = "Épiphanie du Seigneur", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (baptismOfTheLord.hasSame(date, 'day')) data.name = "Le Baptême du Seigneur", data.color[0] = ["white"], data.grade = 2, data.rank = 5
  if (ashWednesday.hasSame(date, 'day')) data.name = "Mercredi des Cendres", data.color[0] = ["purple"], data.grade = "", data.rank = 2
  if (firstLentSunday.hasSame(date, 'day')) data.name = "Premier dimanche de Carême, <em>Invocabit</em>", data.color[0] = ["purple"], data.grade = 1, data.rank = 2
  if (secondLentSunday.hasSame(date, 'day')) data.name = "Deuxième dimanche de Carême, <em>Reminiscere</em>", data.color[0] = ["purple"], data.grade = 1, data.rank = 2
  if (thirdLentSunday.hasSame(date, 'day')) data.name = "Troisième dimanche de Carême, <em>Oculi</em>", data.color[0] = ["purple"], data.grade = 1, data.rank = 2
  if (fourthLentSunday.hasSame(date, 'day')) data.name = "Quatrième dimanche de Carême, <em>Laetare</em>", data.color[0] = ["pink"], data.grade = 1, data.rank = 2
  if (fiveLentSunday.hasSame(date, 'day')) data.name = "Cinquième dimanche de Carême, <em>Judica</em>", data.color[0] = ["purple"], data.grade = 1, data.rank = 2
  if (palmSunday.hasSame(date, 'day')) data.name = "Dimanche des Rameaux et de la Passion du Seigneur", data.color[0] = ["red"], data.grade = 1, data.rank = 2
  if (holyMonday.hasSame(date, 'day')) data.name = "Lundi Saint", data.color[0] = ["purple"], data.grade = "", data.rank = 2
  if (holyTuesday.hasSame(date, 'day')) data.name = "Mardi Saint", data.color[0] = ["purple"], data.grade = "", data.rank = 2
  if (holyWednesday.hasSame(date, 'day')) data.name = "Mercredi Saint", data.color[0] = ["purple"], data.grade = "", data.rank = 2
  if (holyThursday.hasSame(date, 'day')) data.name = "Jeudi Saint", data.color[0] = ["white"], data.grade = 1, data.rank = 1 // @todo rank=2 en journée, rank=1 le soir
  if (goodFriday.hasSame(date, 'day')) data.name = "Vendredi Saint", data.color[0] = ["red"], data.grade = 1, data.rank = 1
  if (holySaturday.hasSame(date, 'day')) data.name = "Samedi Saint", data.color[0] = ["purple"], data.grade = 1, data.rank = 1
  if (easter.hasSame(date, 'day')) data.name = "Résurrection du Seigneur", data.color[0] = ["white"], data.grade = 1, data.rank = 1
  if (easterMonday.hasSame(date, 'day')) data.name = "Lundi dans l'octave Pâques", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (easterTuesday.hasSame(date, 'day')) data.name = "Mardi dans l'octave de Pâques", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (easterWednesday.hasSame(date, 'day')) data.name = "Mercredi dans l'octave de Pâques", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (easterThursday.hasSame(date, 'day')) data.name = "Jeudi dans l'octave de Pâques", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (easterFriday.hasSame(date, 'day')) data.name = "Vendredi dans l'octave de Pâques", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (easterSaturday.hasSame(date, 'day')) data.name = "Samedi dans l'octave de Pâques", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (secondSundayEaster.hasSame(date, 'day')) data.name = "Dimanche de la divine Miséricorde, <em>in albis</em>", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (thirdSundayEaster.hasSame(date, 'day')) data.name = "Troisième dimanche du Temps Pascal", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (fourthSundayEaster.hasSame(date, 'day')) data.name = "Quatrième dimanche du Temps Pascal", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (fiveSundayEaster.hasSame(date, 'day')) data.name = "Cinquième dimanche du Temps Pascal", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (sixSundayEaster.hasSame(date, 'day')) data.name = "Sixième dimanche du Temps Pascal", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (ascension.hasSame(date, 'day')) data.name = "Ascension", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (pentecost.hasSame(date, 'day')) data.name = "Pentecôte", data.color[0] = ["white"], data.grade = 1, data.rank = 2
  if (maryMotherOfTheChurch.hasSame(date, 'day')) data.name = "Bienheureuse Vierge Marie, Mère de l'Église", data.color[0] = ["white"], data.grade = 3, data.rank = 10 // 14
  if (holyTrinity.hasSame(date, 'day')) data.name = "Sainte Trinité", data.color[0] = ["white"], data.grade = 1, data.rank = 3
  if (feastOfCorpusChristi.hasSame(date, 'day')) data.name = "Le Saint Sacrement du Corps et du Sang du Christ (Fête-Dieu)", data.color[0] = ["white"], data.grade = 1, data.rank = 3
  if (sacredHeart.hasSame(date, 'day')) data.name = "Sacré-Cœur de Jésus", data.color[0] = ["white"], data.grade = 1, data.rank = 3
  if (immaculateHeartOfMary.hasSame(date, 'day')) data.name = "Cœur immaculé de Marie", data.color[0] = ["white"], data.grade = 3, data.rank = 10 // 14
  if (christKingOfTheUniverse.hasSame(date, 'day')) data.name = "Notre Seigneur Jésus Christ Roi de l'Univers", data.color[0] = ["white"], data.grade = 1, data.rank = 3
  if (saintsPeterAndPaul.hasSame(date, 'day')) data.name = "Saints Pierre et Paul, apôtres", data.color[0] = ["red"], data.grade = 1, data.rank = 3
  if (saintJoseph.hasSame(date, 'day')) data.name = "Saint Joseph, époux de la Vierge Marie", data.color[0] = ["white"], data.grade = 1, data.rank = 3
  if (annunciation.hasSame(date, 'day')) data.name = "Annonciation du Seigneur", data.color[0] = ["white"], data.grade = 1, data.rank = 3
  if (nativityOfSaintJohnTheBaptist.hasSame(date, 'day')) data.name = "Nativité de Saint Jean-Baptiste", data.color[0] = ["white"], data.grade = 1, data.rank = 3
